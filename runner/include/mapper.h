...
const uint8_t *mapper_get_prg_raw(uint32_t *size);                /* PRG ROM without banking (MMC5) */
...
void mapper_mmc5_dump_regs(uint8_t out[32]);   /* debug snapshot of the MMC5 registers */
